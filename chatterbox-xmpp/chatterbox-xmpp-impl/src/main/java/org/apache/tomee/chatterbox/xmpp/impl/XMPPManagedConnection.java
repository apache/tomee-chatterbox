...
public class XMPPManagedConnection implements ManagedConnection {
    ...
    private static Logger log = Logger.getLogger(XMPPManagedConnection.class.getName());
    ...
    public void associateConnection(Object connection) throws ResourceException {
        ...
        this.connection = (XMPPConnectionImpl) connection;
    }
    ...
    void closeHandle(XMPPConnection handle) {
    ...
    public ManagedConnectionMetaData getMetaData() throws ResourceException {
        ...
        return new XMPPManagedConnectionMetaData();
    }

    void sendMessage(String recipient, String message) throws MessageException {
